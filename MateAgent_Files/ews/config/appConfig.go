...
type UseCaseConfig struct {
	AddAccount              addAccountConfig              `yaml:"addAccount"`
	RemoveUserFromMailGroup removeUserFromMailGroupConfig `yaml:"removeUserFromMailGroup"`
	AddUserToMailGroup      addUserToMailGroupConfig      `yaml:"addUserToMailGroup"`
	Disable                 disableConfig                 `yaml:"disable"`
	Delete                  deleteConfig                  `yaml:"delete"`
	ChangeMailboxSize       ChangeMailboxSizeConfig       `yaml:"changeMailboxSize"`
}

// GetMethodConfig represents AddMailboxAccountConfig use case
type addAccountConfig struct {
	Code string `yaml:"code"`
}

// GetMethodConfig represents RemoveUserFromMailboxConfig use case
type removeUserFromMailGroupConfig struct {
	Code string `yaml:"code"`
}

// GetMethodConfig represents addUserToMailGroupConfig use case
type addUserToMailGroupConfig struct {
	Code string `yaml:"code"`
}

// GetMethodConfig represents DisableMailboxConfig use case
type disableConfig struct {
	Code string `yaml:"code"`
}

// GetMethodConfig represents DeleteMailboxConfig use case
type deleteConfig struct {
	Code string `yaml:"code"`
}

// GetMethodConfig represents ChangeMailboxSizeConfig use case
type ChangeMailboxSizeConfig struct {
	Code string `yaml:"code"`
}
