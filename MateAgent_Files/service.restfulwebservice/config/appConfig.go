...
type AppConfig struct {
	...
	RestfulGrpcConfig DataStoreConfig `yaml:"restfulGrpcConfig"`
...
type UseCaseConfig struct {
	...
	PatchMethod  PatchMethodConfig  `yaml:"patchMethod"`
...
// PatchMethodConfig represents excel use case
type PatchMethodConfig struct {
	Code string `yaml:"code"`
}
