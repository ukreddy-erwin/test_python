...
type UseCaseConfig struct {
	AddRequest     AddRequestConfig     `yaml:"addRequest"`
	ViewAllRequest ViewAllRequestConfig `yaml:"viewAllRequest"`
	ViewRequest    ViewRequestConfig    `yaml:"viewRequest"`
	UpdateRequest  UpdateRequestConfig  `yaml:"updateRequest"`
	GetMethod      GetMethodConfig      `yaml:"getMethod"`
	PostMethod     PostMethodConfig     `yaml:"postMethod"`
	PutMethod      PutMethodConfig      `yaml:"putMethod"`
	DeleteMethod   DeleteMethodConfig   `yaml:"deleteMethod"`
}

// AddRequestConfig represents add request use case
type AddRequestConfig struct {
	Code string `yaml:"code"`
}

// ViewAllRequestConfig represents view all request use case
type ViewAllRequestConfig struct {
	Code string `yaml:"code"`
}

// ViewRequestConfig represents view request use case
type ViewRequestConfig struct {
	Code string `yaml:"code"`
}
type UpdateRequestConfig struct {
	Code string `yaml:"code"`
}
type GetMethodConfig struct {
	Code string `yaml:"code"`
}

// PostMethodConfig represents active directory use case
type PostMethodConfig struct {
	Code string `yaml:"code"`
}

// PutMethodConfig represents excel use case
type PutMethodConfig struct {
	Code string `yaml:"code"`
}

// DeleteMethodConfig represents excel use case
type DeleteMethodConfig struct {
	Code string `yaml:"code"`
}
