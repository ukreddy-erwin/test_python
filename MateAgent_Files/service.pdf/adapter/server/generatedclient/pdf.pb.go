...
type PdfSessionReq struct {
	...
	RwsReq      []*Dictionary `protobuf:"bytes,3,rep,name=rwsReq,proto3" json:"rwsReq,omitempty"`
}
...
func (x *PdfSessionReq) GetRwsReq() []*Dictionary {
	if x != nil {
		return x.RwsReq
	}
	return nil
...
var file_pdf_proto_rawDesc = []byte{
	...
	0x6e, 0x49, 0x64, 0x12, 0x36, 0x0a, 0x06, 0x72, 0x77, 0x73, 0x52, 0x65, 0x71, 0x18, 0x03, 0x20,
	...
	0x61, 0x72, 0x79, 0x52, 0x06, 0x72, 0x77, 0x73, 0x52, 0x65, 0x71, 0x22, 0xa8, 0x01, 0x0a, 0x0e,
...
var file_pdf_proto_depIdxs = []int32{
	3, // 0: pdfgeneratedclient.PdfSessionReq.rwsReq:type_name -> pdfgeneratedclient.Dictionary
