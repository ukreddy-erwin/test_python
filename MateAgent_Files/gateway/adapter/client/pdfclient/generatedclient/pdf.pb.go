...
func (x *PdfSessionResp) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
var file_pdf_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x79, 0x52, 0x06, 0x70, 0x64, 0x66, 0x52, 0x65, 0x71, 0x22, 0x88, 0x01, 0x0a, 0x0e,
...
var file_pdf_proto_depIdxs = []int32{
	...
	4, // 1: pdfgeneratedclient.Dictionary.dictionaryValue:type_name -> pdfgeneratedclient.ListDictionary
	0, // 2: pdfgeneratedclient.PdfService.PdfSession:input_type -> pdfgeneratedclient.PdfSessionReq
	1, // 3: pdfgeneratedclient.PdfService.PdfSession:output_type -> pdfgeneratedclient.PdfSessionResp
